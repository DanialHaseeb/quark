use super::super::lexer::token::{
	identifier::IdentifierKind::*, Token, TokenKind, TokenKind::*,
};
...
/// Consumes the next token if it matches the expected kind otherwise does
/// nothing
...
pub fn consume_and_return_variable<T>(
	tokens_iter: &mut Peekable<T>,
) -> Result<String>
where T: Iterator<Item = Token>
{
